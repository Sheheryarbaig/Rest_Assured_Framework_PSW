...
public enum TopUpPageEnumAndroid {

    XPATH_NAVIGATION_OPTION_START("//android.widget.TextView[(@resource-id='com.etisalat.ewallet:id/tv_bill_type' or @resource-id='com.etisalat.ewallet:id/tv_service_name') and @text='"),
    ...
    private TopUpPageEnumAndroid(String pageVariables) {
