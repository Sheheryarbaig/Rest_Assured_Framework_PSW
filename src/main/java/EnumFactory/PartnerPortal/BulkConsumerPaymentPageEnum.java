...
public enum BulkConsumerPaymentPageEnum {

    XPATH_BULK_CONSUMER_PAYMENT_HEADING("//h1[text()='Upload Batch']"),
    XPATH_FILE_UPLOAD_FIELD("//input[@id='input-file-id']"),
    XPATH_SCHEDULED_DATE_FIELD("//input[@id='scheduledDate']"),
    ...
    private BulkConsumerPaymentPageEnum(String pageVariables) {
